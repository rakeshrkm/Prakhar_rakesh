...
class CreateManpowerSupportsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('manpower_supports', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('manpower_support_image')->nullable();
    ...
    {
        Schema::dropIfExists('manpower_supports');
    }
}
