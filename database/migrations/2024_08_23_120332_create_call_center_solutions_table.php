...
class CreateCallCenterSolutionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('call_center_solutions', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('call_centre_image')->nullable();
    ...
    {
        Schema::dropIfExists('call_center_solutions');
    }
}
