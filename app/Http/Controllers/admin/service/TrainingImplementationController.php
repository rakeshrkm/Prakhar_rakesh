...
class TrainingImplementationController extends Controller
{
    ...
    // Code for FAQ image
        ...
        if ($request->hasFile('banner_image')) {
            $banner_image_path = public_path("/uploads/banner/" . $trainingImplementation->banner_image);
            ...
            $bannerImage->move($bannerDestinationPath, $bannerimgName); // Correct variable here
                ...
                $bannerimgName = $trainingImplementation->banner_image;
            }
        ...
        $trainingImplementation->banner_image = $bannerimgName;
