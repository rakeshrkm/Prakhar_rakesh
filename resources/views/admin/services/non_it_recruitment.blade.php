            ...
            <form action="{{ route('admin.non-it-recruitment.update') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="mb-3 col-md-6">
                        ...
                        <input type="text" name="meta_title" class="form-control" id="" value="{{ !empty($nonItRecruitment->meta_title) ? $nonItRecruitment->meta_title : old('meta_title') }}" placeholder="Enter meta title">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input type="text" name="meta_keywords" class="form-control" id="" value="{{ !empty($nonItRecruitment->meta_keywords) ? $nonItRecruitment->meta_keywords : old('meta_keywords') }}" placeholder="Enter meta keywords">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input type="text" name="meta_descriptions" class="form-control" id="" value="{{ !empty($nonItRecruitment->meta_descriptions) ? $nonItRecruitment->meta_descriptions : old('meta_descriptions') }}" placeholder="Enter meta description">
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <textarea type="text" name="content_1" class="form-control" placeholder="Enter  content"> {{ !empty($nonItRecruitment->content_1) ? $nonItRecruitment->content_1 : old('content_1') }}</textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <textarea type="text" name="content_2" class="form-control" placeholder="Enter  content"> {{ !empty($nonItRecruitment->content_2) ? $nonItRecruitment->content_2 : old('content_2') }} </textarea>
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="" class="form-label">Content 1</label>
                        <textarea type="text" name="key_benefit_content_1" class="form-control" placeholder="Enter  content"> {{ !empty($nonItRecruitment->key_benefit_content_1) ? $nonItRecruitment->key_benefit_content_1 : old('key_benefit_content_1') }}  </textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <textarea type="text" name="key_benefit_content_1_2" class="form-control" placeholder="Enter  content"> {{ !empty($nonItRecruitment->key_benefit_content_1_2) ? $nonItRecruitment->key_benefit_content_1_2 : old('key_benefit_content_1_2') }}  </textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="" class="form-label">Content 2</label>
                        <textarea type="text" name="key_benefit_content_2" class="form-control" placeholder="Enter  content"> {{ !empty($nonItRecruitment->key_benefit_content_2) ? $nonItRecruitment->key_benefit_content_2 : old('key_benefit_content_2') }} </textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <textarea type="text" name="key_benefit_content_2_2" class="form-control" placeholder="Enter  content"> {{ !empty($nonItRecruitment->key_benefit_content_2_2) ? $nonItRecruitment->key_benefit_content_2_2 : old('key_benefit_content_2_2') }} </textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <textarea type="text" name="key_benefit_content_3_2" class="form-control" placeholder="Enter content 3"> {{ !empty($nonItRecruitment->key_benefit_content_3_2) ? $nonItRecruitment->key_benefit_content_3_2 : old('key_benefit_content_3_2') }} </textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <textarea type="text" name="key_benefit_content_4" class="form-control" placeholder="Enter  content"> {{ !empty($nonItRecruitment->key_benefit_content_4) ? $nonItRecruitment->key_benefit_content_4 : old('key_benefit_content_4') }}</textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <textarea type="text" name="key_benefit_content_4_2" class="form-control" placeholder="Enter  content"> {{ !empty($nonItRecruitment->key_benefit_content_4_2) ? $nonItRecruitment->key_benefit_content_4_2 : old('key_benefit_content_4_2') }}</textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <textarea type="text" name="key_benefit_content_5_2" class="form-control" placeholder="Enter content 5"> {{ !empty($nonItRecruitment->key_benefit_content_5_2) ? $nonItRecruitment->key_benefit_content_5_2 : old('key_benefit_content_5_2') }} </textarea>
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="" class="form-label">Content 1</label>
                        <textarea type="text" name="choose_us_content_1" class="form-control" placeholder="Enter  content"> {{ !empty($nonItRecruitment->choose_us_content_1) ? $nonItRecruitment->choose_us_content_1 : old('choose_us_content_1') }} </textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="" class="form-label">Content 1.2</label>
                        <textarea type="text" name="choose_us_content_1_2" class="form-control" placeholder="Enter  content"> {{ !empty($nonItRecruitment->choose_us_content_1_2) ? $nonItRecruitment->choose_us_content_1_2 : old('choose_us_content_1_2') }} </textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="" class="form-label">Content 2</label>
                        <textarea type="text" name="choose_us_content_2" class="form-control" placeholder="Enter  content">{{ !empty($nonItRecruitment->choose_us_content_2) ? $nonItRecruitment->choose_us_content_2 : old('choose_us_content_2') }}</textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="" class="form-label">Content 2.2</label>
                        <textarea type="text" name="choose_us_content_2_2" class="form-control" placeholder="Enter content">{{ !empty($nonItRecruitment->choose_us_content_2_2) ? $nonItRecruitment->choose_us_content_2_2 : old('choose_us_content_2_2') }}</textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="" class="form-label">Content 3.2</label>
                        <textarea type="text" name="choose_us_content_3_2" class="form-control" placeholder="Enter content 3"> {{ !empty($nonItRecruitment->choose_us_content_3_2) ? $nonItRecruitment->choose_us_content_3_2 : old('choose_us_content_3_2') }} </textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="" class="form-label">Content 4</label>
                        <textarea type="text" name="choose_us_content_4" class="form-control" placeholder="Enter  content"> {{ !empty($nonItRecruitment->choose_us_content_4) ? $nonItRecruitment->choose_us_content_4 : old('choose_us_content_4') }} </textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="" class="form-label">Content 4.2</label>
                        <textarea type="text" name="choose_us_content_4_2" class="form-control" placeholder="Enter content"> {{ !empty($nonItRecruitment->choose_us_content_4_2) ? $nonItRecruitment->choose_us_content_4_2 : old('choose_us_content_4_2') }} </textarea>
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        @if(!empty($nonItRecruitment->banner_image))
                            <img class="mt-2" src="{{asset('uploads/banner/'.$nonItRecruitment->banner_image)}}" height="80"  width="80"  />
                        @endif
                    </div>
                </div>
                <div class="row">
