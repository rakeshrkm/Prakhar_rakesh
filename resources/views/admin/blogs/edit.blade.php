    ...
    <div class="container">
        ...
        <div class="row">
          <div class="mb-3 col-md-12">
            ...
            <input type="text" name="title" class="form-control" id="" value="{{ $blog->title }}" placeholder="Enter title">
            @if($errors->has('title'))
          ...
          <div class="mb-3 col-md-12">
            ...
            <textarea type="text" name="content" class="form-control" placeholder="Enter blog content"> {{ $blog->content }} </textarea>
          ...
          <div class="mb-3 col-md-12">
            ...
            <select name="status" class="form-control">
                ...
                <option value="active" {{ $blog->status == App\Helpers\ConstantHelper::ACTIVE ? 'selected' : '' }} >Active</option>
                <option value="inactive" {{ $blog->status == App\Helpers\ConstantHelper::INACTIVE ? 'selected' : '' }}>In Active</option>
            </select>
