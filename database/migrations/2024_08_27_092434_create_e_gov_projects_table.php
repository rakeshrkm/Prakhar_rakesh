...
class CreateEGovProjectsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('e_gov_projects', function (Blueprint $table) {
            $table->id();
            ...
            $table->text('content_3_2')->nullable();
            $table->string('heading_4')->nullable();
            $table->text('content_4')->nullable();
            $table->text('content_4_1')->nullable();
            $table->text('content_4_2')->nullable();
            $table->string('heading_5')->nullable();
            $table->text('content_5')->nullable();
            $table->text('content_5_1')->nullable();
            $table->text('content_5_2')->nullable();
            $table->string('e_gov_image')->nullable();    
    ...
    {
        Schema::dropIfExists('e_gov_projects');
    }
}
