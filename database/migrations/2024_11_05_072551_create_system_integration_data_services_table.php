...
class CreateSystemIntegrationDataServicesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('system_integration_data_services', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('system_integration_image')->nullable();
    ...
    {
        Schema::dropIfExists('system_integration_data_services');
    }
}
