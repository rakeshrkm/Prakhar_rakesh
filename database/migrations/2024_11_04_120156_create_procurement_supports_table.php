...
class CreateProcurementSupportsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('procurement_supports', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('procurement_support_image')->nullable();
    ...
    {
        Schema::dropIfExists('procurement_supports');
    }
}
