@extends('layouts.front.master', ['title' => $data['scanningDigit']->meta_title, 'keyword' => $data['scanningDigit']->meta_keywords,'description' => $data['scanningDigit']->meta_descriptions ])
@section('content')
    <!-- navbar end -->

    <!-- page title start -->
    <div class="breadcrumb-area bg-black bg-relative">
        <div class="banner-bg-img" style="background-image: url({{ asset('uploads/banner/'. $data['scanningDigit']->banner_image) }});"></div>
        <div class="container">
                ...
                <div class="col-xl-7 col-lg-8">
                    <div class="breadcrumb-inner text-center">
                        ...
                        <ul class="page-list">
                          ...
                          <li>Scanning and Digitization and Document management System</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-8">
                    <div class="blog-details-page-content">
                        <div class="single-blog-inner">
                            <div class="thumb">
                                <img src="{{ asset('uploads/services/'. $data['scanningDigit']->scanning_digitization_image) }}" alt="{{ $data['scanningDigit']->scanning_digitization_image }}" title="{{ $data['scanningDigit']->scanning_digitization_image }}" class="w-100">
                            </div>
                            <div class="details">
                                <h1>{{ $data['scanningDigit']->heading_1 }}</h1>
                                <p>{{ $data['scanningDigit']->content_1 }}</p>
                                <h2>{{ $data['scanningDigit']->heading_2 }}</h2>
                                <p>{{ $data['scanningDigit']->content_2 }}</p>
                                <h2>{{ $data['scanningDigit']->heading_3 }}</h2>
                                <p>{{ $data['scanningDigit']->content_3 }}</p>
                                <h4 class="pt-4 mb-4">{{ $data['scanningDigit']->key_benefit_title }}</h4>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="media single-choose-inner">
                                            ...
                                            <div class="media-body">
                                                <h4>{{ $data['scanningDigit']->key_benefit_heading_1 }}</h4>
                                                <p>{{ $data['scanningDigit']->key_benefit_content_1 }}</p>
                                            </div>
                                        </div>
                                        <div class="media single-choose-inner">
                                            <div class="media-left">
                                            ...
                                            <div class="media-body">
                                                <h4>{{ $data['scanningDigit']->key_benefit_heading_2 }}</h4>
                                                <p>{{ $data['scanningDigit']->key_benefit_content_2 }}</p>
                                            </div>
                                        </div>
                                         <div class="media single-choose-inner">
                                            <div class="media-left">
                                            ...
                                            <div class="media-body">
                                                <h4>{{ $data['scanningDigit']->key_benefit_heading_3 }}</h4>
                                                <p>{{ $data['scanningDigit']->key_benefit_content_3 }}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="media single-choose-inner">
                                            ...
                                            <div class="media-body">
                                                <h4>{{ $data['scanningDigit']->key_benefit_heading_4 }}</h4>
                                                <p>{{ $data['scanningDigit']->key_benefit_content_4 }}</p>
                                            </div>
                                        </div>
                                        <div class="media single-choose-inner">
                                            <div class="media-left">
                                            ...
                                            <div class="media-body">
                                                <h4>{{ $data['scanningDigit']->key_benefit_heading_5 }}</h4>
                                                <p>{{ $data['scanningDigit']->key_benefit_content_5 }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <h2>{{ $data['scanningDigit']->choose_us_title }}</h2>
                                <p>{{ $data['scanningDigit']->choose_us_content }}</p>
                                <h4>{{ $data['scanningDigit']->choose_us_heading_1 }}</h4>
                                <ul>
                                    <li>{{ $data['scanningDigit']->choose_us_content_1 }}</li>
                                </ul>
                                <h4>{{ $data['scanningDigit']->choose_us_heading_2 }}</h4>
                                <ul>
                                    <li>{{ $data['scanningDigit']->choose_us_content_2 }}</li>
                                </ul>
                                
                                <h4>{{ $data['scanningDigit']->choose_us_heading_3 }}</h4>
                                <ul>
                                    <li>{{ $data['scanningDigit']->choose_us_content_3 }}</li>
                                </ul>
                                
                                <h4>{{ $data['scanningDigit']->choose_us_heading_4 }}</h4>
                                <ul>
                                    <li>{{ $data['scanningDigit']->choose_us_content_4 }}</li>
                                </ul>
                                <h4>{{ $data['scanningDigit']->choose_us_heading_5 }}</h4>
                                <ul>
                                    <li>{{ $data['scanningDigit']->choose_us_content_5 }}</li>
                                </ul>
                    
                                <h4  class="mt-2">{{ $data['scanningDigit']->faq_title }}</h4>
                                <div class="row">
                                    <div class="col-md-8">
                                            ...
                                            <div class="accordion-item single-accordion-inner style-2">
                                                <h2 class="accordion-header" id="headingOne">
                                                    <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                                        {{ $data['scanningDigit']->faq_heading_1 }}
                                                    </button>
                                                </h2>
                                                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        {{ $data['scanningDigit']->faq_content_1 }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="accordion-item single-accordion-inner style-2">
                                                <h2 class="accordion-header" id="headingTwo">
                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                                        {{ $data['scanningDigit']->faq_heading_2 }}
                                                    </button>
                                                </h2>
                                                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        {{ $data['scanningDigit']->faq_content_2 }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="accordion-item single-accordion-inner style-2">
                                                <h2 class="accordion-header" id="headingThree">
                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                                        {{ $data['scanningDigit']->faq_heading_3 }}
                                                    </button>
                                                </h2>
                                                <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        {{ $data['scanningDigit']->faq_content_3 }}
                                                    </div>
                                                </div>
                                            </div>
                                             <div class="accordion-item single-accordion-inner style-2">
                                                <h2 class="accordion-header" id="headingFour">
                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                                                        {{ $data['scanningDigit']->faq_heading_4 }}
                                                    </button>
                                                </h2>
                                                <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        {{ $data['scanningDigit']->faq_content_4 }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="accordion-item single-accordion-inner style-2">
                                                <h2 class="accordion-header" id="headingFive">
                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="false" aria-controls="collapseThree">
                                                        {{ $data['scanningDigit']->faq_heading_5 }}
                                                    </button>
                                                </h2>
                                                <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        {{ $data['scanningDigit']->faq_content_5 }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="accordion-item single-accordion-inner style-2">
                                                <h2 class="accordion-header" id="headingSix">
                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
                                                        {{ $data['scanningDigit']->faq_heading_6 }}
                                                    </button>
                                                </h2>
                                                <div id="collapseSix" class="accordion-collapse collapse" aria-labelledby="headingSix" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        {{ $data['scanningDigit']->faq_content_6 }}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
