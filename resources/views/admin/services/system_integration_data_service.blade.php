            ...
            <form action="{{ route('admin.system-integration-data-service.update') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="mb-3 col-md-6">
                        ...
                        <input type="text" name="meta_title" class="form-control" id="" value="{{ !empty($systemIntegration->meta_title) ? $systemIntegration->meta_title : old('meta_title') }}" placeholder="Enter meta title">
                        <!-- <input type="hidden" name="id" value="{{ !empty($systemIntegration->id) ?   $systemIntegration->id : old('') }}"/> -->
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input type="text" name="meta_keywords" class="form-control" id="" value="{{ !empty($systemIntegration->meta_keywords) ? $systemIntegration->meta_keywords : old('meta_keywords') }}" placeholder="Enter meta keywords">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input type="text" name="meta_descriptions" class="form-control" id="" value="{{ !empty($systemIntegration->meta_descriptions) ? $systemIntegration->meta_descriptions : old('meta_descriptions') }}" placeholder="Enter meta description">
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <textarea type="text" name="content_1" class="form-control" placeholder="Enter contents"> {{ !empty($systemIntegration->content_1) ? $systemIntegration->content_1 : old('content_1') }}</textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <textarea type="text" name="content_2" class="form-control" placeholder="Enter contents"> {{ !empty($systemIntegration->content_2) ? $systemIntegration->content_2 : old('content_2') }} </textarea>
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="" class="form-label">Content 1</label>
                        <textarea type="text" name="key_benefit_content_1" class="form-control" placeholder="Enter contents"> {{ !empty($systemIntegration->key_benefit_content_1) ? $systemIntegration->key_benefit_content_1 : old('key_benefit_content_1') }} </textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <textarea type="text" name="key_benefit_content_1_2" class="form-control" placeholder="Enter contents"> {{ !empty($systemIntegration->key_benefit_content_1_2) ? $systemIntegration->key_benefit_content_1_2 : old('key_benefit_content_1_2') }} </textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="" class="form-label">Content 2</label>
                        <textarea type="text" name="key_benefit_content_2" class="form-control" placeholder="Enter contents"> {{ !empty($systemIntegration->key_benefit_content_2) ? $systemIntegration->key_benefit_content_2 : old('key_benefit_content_2') }} </textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <textarea type="text" name="key_benefit_content_2_2" class="form-control" placeholder="Enter contents"> {{ !empty($systemIntegration->key_benefit_content_2_2) ? $systemIntegration->key_benefit_content_2_2 : old('key_benefit_content_2_2') }} </textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <textarea type="text" name="key_benefit_content_3_2" class="form-control" placeholder="Enter content 3"> {{ !empty($systemIntegration->key_benefit_content_3_2) ? $systemIntegration->key_benefit_content_3_2 : old('key_benefit_content_3_2') }} </textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <textarea type="text" name="key_benefit_content_4" class="form-control" placeholder="Enter contents"> {{ !empty($systemIntegration->key_benefit_content_4) ? $systemIntegration->key_benefit_content_4 : old('key_benefit_content_4') }}</textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <textarea type="text" name="key_benefit_content_4_2" class="form-control" placeholder="Enter contents"> {{ !empty($systemIntegration->key_benefit_content_4_2) ? $systemIntegration->key_benefit_content_4_2 : old('key_benefit_content_4_2') }}</textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <textarea type="text" name="key_benefit_content_5_2" class="form-control" placeholder="Enter content 5"> {{ !empty($systemIntegration->key_benefit_content_5_2) ? $systemIntegration->key_benefit_content_5_2 : old('key_benefit_content_5_2') }} </textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <textarea type="text" name="key_benefit_content_6_2" class="form-control" placeholder="Enter content 6"> {{ !empty($systemIntegration->key_benefit_content_6_2) ? $systemIntegration->key_benefit_content_6_2 : old('key_benefit_content_6_2') }} </textarea>
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="" class="form-label">Content 1</label>
                        <textarea type="text" name="choose_us_content_1" class="form-control" placeholder="Enter contents"> {{ !empty($systemIntegration->choose_us_content_1) ? $systemIntegration->choose_us_content_1 : old('choose_us_content_1') }} </textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="" class="form-label">Content 1.2</label>
                        <textarea type="text" name="choose_us_content_1_2" class="form-control" placeholder="Enter contents"> {{ !empty($systemIntegration->choose_us_content_1_2) ? $systemIntegration->choose_us_content_1_2 : old('choose_us_content_1_2') }} </textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="" class="form-label">Content 2</label>
                        <textarea type="text" name="choose_us_content_2" class="form-control" placeholder="Enter contents">{{ !empty($systemIntegration->choose_us_content_2) ? $systemIntegration->choose_us_content_2 : old('choose_us_content_2') }}</textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="" class="form-label">Content 2.2</label>
                        <textarea type="text" name="choose_us_content_2_2" class="form-control" placeholder="Enter contents">{{ !empty($systemIntegration->choose_us_content_2_2) ? $systemIntegration->choose_us_content_2_2 : old('choose_us_content_2_2') }}</textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="" class="form-label">Content 3.2</label>
                        <textarea type="text" name="choose_us_content_3_2" class="form-control" placeholder="Enter content 3"> {{ !empty($systemIntegration->choose_us_content_3_2) ? $systemIntegration->choose_us_content_3_2 : old('choose_us_content_3_2') }} </textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="" class="form-label">Content 4</label>
                        <textarea type="text" name="choose_us_content_4" class="form-control" placeholder="Enter contents"> {{ !empty($systemIntegration->choose_us_content_4) ? $systemIntegration->choose_us_content_4 : old('choose_us_content_4') }} </textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="" class="form-label">Content 4.2</label>
                        <textarea type="text" name="choose_us_content_4_2" class="form-control" placeholder="Enter contents"> {{ !empty($systemIntegration->choose_us_content_4_2) ? $systemIntegration->choose_us_content_4_2 : old('choose_us_content_4_2') }} </textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="" class="form-label">Content 5</label>
                        <textarea type="text" name="choose_us_content_5" class="form-control" placeholder="Enter contents"> {{ !empty($systemIntegration->choose_us_content_5) ? $systemIntegration->choose_us_content_5 : old('choose_us_content_5') }} </textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="" class="form-label">Content 5.2</label>
                        <textarea type="text" name="choose_us_content_5_2" class="form-control" placeholder="Enter contents"> {{ !empty($systemIntegration->choose_us_content_5_2) ? $systemIntegration->choose_us_content_5_2 : old('choose_us_content_5_2') }} </textarea>
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="" class="form-label">Content 6.2</label>
                        <textarea type="text" name="choose_us_content_6_2" class="form-control" placeholder="Enter content"> {{ !empty($systemIntegration->choose_us_content_6_2) ? $systemIntegration->choose_us_content_6_2 : old('choose_us_content_6_2') }} </textarea>
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        @if(!empty($systemIntegration->banner_image))
                        <img class="mt-2" src="{{ asset('uploads/banner/'.$systemIntegration->banner_image) }}" height="80" width="80" />
                        @endif
                    </div>
                </div>
                <div class="row">
