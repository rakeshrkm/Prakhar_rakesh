...
class CreateTrainingExcellencePartnersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('training_excellence_partners', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('training_excellence_partner_image')->nullable();
    ...
    {
        Schema::dropIfExists('training_excellence_partners');
    }
}
